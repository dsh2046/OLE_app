    ...
    $.ajax({
        ...
        success: function(data){
            if(data.email){
                ...
                Dml.fun.showErrorTips($('#jsChangeEmailTips'), "Verified code sent");
            }else if(data.status == 'failure'){
                 Dml.fun.showValidateError($('#jsChangeEmail'), "Fail to send verified code");
            }else if(data.status == 'success'){
            }
        },
        complete: function(XMLHttpRequest){
            $btn.val("Get verified code");
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(data.email){
                ...
                Dml.fun.showErrorTips($('#jsChangePhoneTips'), "Email information updated");
            ...
            success: function(data) {
                if(data.password1){
                    ...
                    Dml.fun.showTipsDialog({
                        title:'Apply succeeded',
                        h2:'Successfully updated password,please login again!',
                    });
                    Dml.fun.winReload();
                }else if(data.msg){
                ...
                if(data.nick_name){
                   ...
                   _showValidateError($('#address'), data.address);
                    ...
                    Dml.fun.showTipsDialog({
                        ...
                        h2: 'Personal information has been saved！'
                    });
